...
public class Base64  {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(new String(encodeBase64("1111111".getBytes())));
    }
...
//         String result = tempStr+baseStr;
         return new String(encode(baseStr.getBytes("UTF-8")));
     }
...
//         String result = tempStr.substring(40, tempStr.length());
         return new String(decode(tempStr.getBytes("UTF-8")));
       }
