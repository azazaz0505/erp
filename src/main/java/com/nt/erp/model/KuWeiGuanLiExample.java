...
public class KuWeiGuanLiExample {
     ...
     * @author hewei
     */
    public KuWeiGuanLiExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public KuWeiGuanLiExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public KuWeiGuanLiExample page(Integer page, Integer pageSize) {
     ...
     * @author hewei
     */
    public KuWeiGuanLiExample orderBy(String orderByClause) {
     ...
     * @author hewei
     */
    public KuWeiGuanLiExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private KuWeiGuanLiExample example;

        protected Criteria(KuWeiGuanLiExample example) {
            super();
         ...
         * @author hewei
         */
        public KuWeiGuanLiExample example() {
            return this.example;
        }
